...
class App extends Component {
  ...
  _logout(event) {
    ...
    axios.post("https://git.heroku.com/student-hub-heroku.git/auth/logout").then(response => {
  ...
  _login(username, password) {
    ...
    axios.post("https://git.heroku.com/student-hub-heroku.git/auth/login", { username, password }).then(response => {
